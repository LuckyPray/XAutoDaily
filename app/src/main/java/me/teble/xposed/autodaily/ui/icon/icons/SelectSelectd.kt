...
public val Icons.SelectSelectd: ImageVector
    get() {
        if (_selectSelectd != null) {
            return _selectSelectd!!
        }
        _selectSelectd = Builder(
            name = "SelectSelectd", defaultWidth = 24.0.dp, defaultHeight =
...
private var _selectSelectd: ImageVector? = null
