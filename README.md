...
- 安卓12太极阴64位QQ用户: **太极9.3.1+已修复安卓12闪退问题[点此下载9.4.4](https://taichi.lanzoue.com/iKx2A08zcwdg?w1)** ~由于太极在安卓12上可能存在bug，勾选XA后会导致QQ闪退（根据日志查看，art崩溃不属于模块本身的bug），请更换32位QQ或者更换框架以解决问题。~
